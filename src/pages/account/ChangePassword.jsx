      ...
      <div className="change-password-card">
        {success && (
          <div className="password-success-message">
            <svg className="password-message-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
