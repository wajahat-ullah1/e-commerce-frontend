...
export function Badge({
  ...
  return (
    <span
      className={`ui-badge ${badgeStyles[variant] || badgeStyles.default}`}
    >
      {children}
    </span>
  );
...
export function Input({
  ...
  return (
    <div className="ui-input-group">
      ...
      {error && (
        <p className="ui-input-error-message">
          {error}
        </p>
      )}
...
const toastConfig = {
  ...
  warning: {
    icon: (
      <AlertTriangle className="toast-icon-warning" />
    ),
    style: "toast-warning",
  },
  ...
  info: {
    icon: (
      <Info className="toast-icon-info" />
    ),
    style: "toast-info",
  },
};
...
export function Toast({
  ...
  return (
    <div
      className={`ui-toast ${config.style}`}
    >
      {config.icon}
...
export function StatCard({
  ...
  return (
    <Card className="ui-stat-card">
      ...
      <div className="ui-stat-change-label">
        {changeLabel}
      </div>
...
export function Avatar({
  ...
  return (
    <div
      className={`ui-avatar ${sizeClass} ${color}`}
    >
      {initials}
    </div>
  );
